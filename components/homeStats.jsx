...
const HomeAnalytics = memo(function HomeAnalytics() {
 ...
 return (
  <div className="grid sm:grid-cols-2 gap-4 my-6 rounded-lg p-2">
   <Stats icon={totalEarning} text="Total Earnings" value={nbf.format(data.totalEarning || 0) + ' 💸'} />
   <Stats icon={acctBalance} text="Current Balance" value={nbf.format(data.balance || 0) + ' 💸'} />
