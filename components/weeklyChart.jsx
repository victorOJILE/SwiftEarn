...
const ChartComp = memo(function ChartComp({ uid }) {
	...
	useLayoutEffect(() => {
	 try {
  	renderWeeklyDataChart(chart.current, data);
	...
	return (
	 <div ref={chart} className="border-2 border bg-8"><Loader /></div>
	);
});
