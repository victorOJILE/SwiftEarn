export default function homeAnalytics(uid) {
	let user;
	return cEl('div', 
		...
		cEl('div', {},
			...
			cEl('div', { class: 'bg-blue-900 py-4 px-6 rounded-xl' },
				cEl('span', { class: 'text-2xl text-gray-100 font-bold', textContent: '$0' + '💸' }),
				cEl('br'),
				cEl('div', { class: 'text-gray-400' },
					cEl('span', { class: 'text-xs', textContent: 'Last updated: ' + '2mins' })
				),
			)
		),
		user && cEl('div', {},
